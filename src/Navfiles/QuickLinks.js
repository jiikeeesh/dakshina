...
const QuickLinks = () => {
  ...
  <section id='team-main'>
      ...
      <ul className='quick-links'>
                           ...
                           <li className="gun"><Link to="/" className=''><span>कर्जा सुविधा</span></Link></li>
                           <li className="gun"><Link to="/" className=''><span>कर्जा सुविधा</span></Link></li>
                           <li className="gun"><Link to="/" className=''><span>वित्तिय विवरण</span></Link></li>
                           <li className="gun"><Link to="/" className=''><span>नेपाल सरकारलाई राजश्वमा गरेको योगदान</span></Link></li>
                           </ul>
